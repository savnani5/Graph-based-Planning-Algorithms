...
class Node:
    ...
    def __init__(self, state, parent, cost_to_come, distance_from_parent):
    ...
    def up(self):
        ...
        if not self.check_obstacle_space(pot_node):
            up_node = Node(copy.deepcopy(self.state), Node(self.state, self.parent, self.cost_to_come, self.distance_from_parent), self.cost_to_come + 1, 1)
    ...
    def down(self):
        ...
        pot_node = (self.state[0], self.state[1] - 1)
        if not self.check_obstacle_space(pot_node):
            down_node = Node(copy.deepcopy(self.state), Node(self.state, self.parent, self.cost_to_come, self.distance_from_parent), self.cost_to_come + 1, 1)
    ...
    def left(self):
        ...
        if not self.check_obstacle_space(pot_node):
            left_node = Node(copy.deepcopy(self.state), Node(self.state, self.parent, self.cost_to_come, self.distance_from_parent), self.cost_to_come + 1, 1)
    ...
    def right(self):
        ...
        pot_node = (self.state[0] + 1, self.state[1])
        if not self.check_obstacle_space(pot_node):
            right_node = Node(copy.deepcopy(self.state), Node(self.state, self.parent, self.cost_to_come, self.distance_from_parent), self.cost_to_come + 1, 1)
    ...
    def up_left(self):
        ...
        if not self.check_obstacle_space(pot_node):
            up_left_node = Node(copy.deepcopy(self.state), Node(self.state, self.parent, self.cost_to_come, self.distance_from_parent), self.cost_to_come + 1.414, 1.414)
    ...
    def up_right(self):
        ...
        pot_node = (self.state[0] + 1, self.state[1] + 1)
        if not self.check_obstacle_space(pot_node):
            up_right_node = Node(copy.deepcopy(self.state), Node(self.state, self.parent, self.cost_to_come, self.distance_from_parent), self.cost_to_come + 1.414, 1.414)
    ...
    def down_left(self):
        ...
        pot_node = (self.state[0] - 1, self.state[1] - 1)
        if not self.check_obstacle_space(pot_node):
            down_left_node = Node(copy.deepcopy(self.state), Node(self.state, self.parent, self.cost_to_come, self.distance_from_parent), self.cost_to_come + 1.414, 1.414)
    ...
    def down_right(self):
        ...
        pot_node = (self.state[0] + 1, self.state[1] - 1)
        if not self.check_obstacle_space(pot_node):
            down_right_node = Node(copy.deepcopy(self.state), Node(self.state, self.parent, self.cost_to_come, self.distance_from_parent), self.cost_to_come + 1.414, 1.414)
...
if __name__== "__main__":
    ...
    while(1):
        queue.sort(key = lambda x: x.cost_to_come)
    ...
    #____________________________________________________
        ...
        if current_node.state not in visited_states:
            ...
            if current_node.cost_to_come > parent_node.cost_to_come + current_node.distance_from_parent:
                current_node.cost_to_come = parent_node.cost_to_come + current_node.distance_from_parent
